...
namespace Manag_ph.forms
{
    public partial class reason_for_user : Form
    {
        ...
        private void Reason_for_user_Load(object sender, EventArgs e)
        {
            ...
            dgv_Compny.DataSource = DB_Add_delete_update_.Database.ds.Tables["reason_for_user"];
        }
        ...
        private void Btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr == DialogResult.OK)
                {
                    ...
                    ClareData();
                    DB_Add_delete_update_.Database.ds.Tables["reason_for_user"].Rows.RemoveAt(dgv_Compny.CurrentRow.Index);
                    dgv_Compny.DataSource = DB_Add_delete_update_.Database.ds.Tables["reason_for_user"];
                }
            }
            catch (Exception ex)
        ...
        private void Btn_update_Click(object sender, EventArgs e)
        {
            if (txt_com.Text.Trim() != string.Empty)
            {
                DB_Add_delete_update_.Database.ds.Tables["reason_for_user"].Rows[dgv_Compny.CurrentRow.Index][1] = txt_com.Text;
                DB_Add_delete_update_.Database.update("reason_for_user");
            }
            else
            {
