...
namespace Manag_ph.forms
{
    public partial class Compny_Frm : Form
    {
        ...
        private void Compny_Frm_Load(object sender, EventArgs e)
        {
            ...
            dgv_Compny.DataSource = DB_Add_delete_update_.Database.ds.Tables["manufctur_company"];
        }
        ...
        private void Btn_delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dr == DialogResult.OK)
                {
                    ...
                    DB_Add_delete_update_.Database.ds.Tables["manufctur_company"].Rows.RemoveAt(dgv_Compny.CurrentRow.Index);
                    dgv_Compny.DataSource = DB_Add_delete_update_.Database.ds.Tables["manufctur_company"];
                    ClareData();
                }
            }
        ...
        private void Btn_update_Click(object sender, EventArgs e)
        {
            ...
            if (txt_com.Text.Trim()!=string.Empty) {
                DB_Add_delete_update_.Database.ds.Tables["manufctur_company"].Rows[dgv_Compny.CurrentRow.Index][1] = txt_com.Text;
                DB_Add_delete_update_.Database.update("manufctur_company");
