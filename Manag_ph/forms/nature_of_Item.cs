...
namespace Manag_ph.forms
{
    public partial class nature_of_Item : Form
    {
        ...
        private void Nature_of_Item_Load(object sender, EventArgs e)
        {
            ...
            dgv_Compny.DataSource = DB_Add_delete_update_.Database.ds.Tables["nature_of_Item"];
        }
        ...
        private void Btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr == DialogResult.OK)
                {
                    ...
                    DB_Add_delete_update_.Database.ds.Tables["nature_of_Item"].Rows.RemoveAt(dgv_Compny.CurrentRow.Index);
                    dgv_Compny.DataSource = DB_Add_delete_update_.Database.ds.Tables["nature_of_Item"];
                    ClareData();
        ...
        private void Btn_update_Click(object sender, EventArgs e)
        {
            if (txt_com.Text.Trim() != string.Empty)
            {
                DB_Add_delete_update_.Database.ds.Tables["nature_of_Item"].Rows[dgv_Compny.CurrentRow.Index][1] = txt_com.Text;
                DB_Add_delete_update_.Database.update("nature_of_Item");
                ClareData();
            }
            else
