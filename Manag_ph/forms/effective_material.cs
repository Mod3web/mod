...
namespace Manag_ph.forms
{
    public partial class effective_material : Form
    {
        ...
        private void Effective_material_Load(object sender, EventArgs e)
        {
            ...
            dgv_Compny.DataSource = DB_Add_delete_update_.Database.ds.Tables["effective_material"];
        }
        ...
        private void Btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr == DialogResult.OK)
                {
                    ...
                    ClareData();
                    DB_Add_delete_update_.Database.ds.Tables["effective_material"].Rows.RemoveAt(dgv_Compny.CurrentRow.Index);
                    dgv_Compny.DataSource = DB_Add_delete_update_.Database.ds.Tables["effective_material"];
                }
            }
            catch (Exception ex)
        ...
        private void Btn_update_Click(object sender, EventArgs e)
        {
            if (txt_com.Text.Trim() != string.Empty)
            {
                DB_Add_delete_update_.Database.ds.Tables["effective_material"].Rows[dgv_Compny.CurrentRow.Index][1] = txt_com.Text;
                DB_Add_delete_update_.Database.update("effective_material");
            }
            else
            {
